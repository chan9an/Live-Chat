                  ...
                  <TabPanel key={category.name} className="space-y-10 px-4 pt-10 pb-8">
                    ...
                    {category.sections.map((section) => (
                      <div key={section.name}>
                        <p id={`${category.id}-${section.id}-heading-mobile`} className="font-medium text-blue-900">
                          {section.name}
                        </p>
                        <ul
                          role="list"
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className='ml-4 flow-root lg:ml-6'>
                  <a href='#' >
                    <HeartIcon
                      aria-hidden="true"
                      className="ml-3 size-5 shrink-0 text-gray-400 group-hover:text-gray-500"

                    />
                    <span className='text-[13px] text-center font-bold'>Wishlist</span>
                  </a>
                </div>
                {/* Cart */}
                <div className="relative ml-4 flow-root lg:ml-6">
                  <a href="#" className="relative flex items-center">
                    ...
                    <div className="flex items-center">
                      ...
                      {/* Bag Text */}
                      <span className="ml-2 text-[13px] font-bold">Bag</span>
                    </div>

                    {/* Red Notification Badge */}
                    <span className="absolute -top-2 -right-2 flex h-4 w-4 items-center justify-center rounded-full bg-red-600 text-xs font-bold text-white">
                      0
                    </span>
                  </a>
                </div>
